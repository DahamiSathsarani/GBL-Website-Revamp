  ...
  return (
    <section className="bg-success-stories w-full xs:h-[40rem] h-[40rem] sm:h-[45rem]  lg:h-[43rem]  2xl:h-[47rem] bg-cover bg-center">
      <div className=" h-full bg-[#1C3A7B] bg-opacity-50">
        <motion.div
          className="flex items-center justify-center p-8 text-3xl sm:text-5xl font-bold text-white h-[10rem] w-full"
        ...
        <div className="xs:h-[25rem] h-[25rem] sm:h-[30rem] lg:h-[27rem] 2xl:h-[30rem] flex items-center justify-center">
          ...
          >
            ...
            <p className="text-center px-5 sm:px-10 xs:text-[11px] text-[13px] sm:text-[16px] lg:text-[18px] 2xl:text-[20px]">
              Working with GBL has been an absolute pleasure. Their team
              demonstrated exceptional expertise delivering a robust & scalable
              software solution that exceeded our expectations. Not only did
              they adhere to deadlines with precision, but their proactive
              communication and attention to detail ensured a smooth development
              process from start to finish. I highly recommend Global Bridge
              Labs to anyone seeking top-notch software development services.
            </p>

            <div className="w-[100%] flex items-center justify-center py-5 sm:py-0  sm:mt-8">
              <div className="w-[90px] mx-5">
                <img
                  src={images.DirectorImage}
                  alt="Director-Image"
