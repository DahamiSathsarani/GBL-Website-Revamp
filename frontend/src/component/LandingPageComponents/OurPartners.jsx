      ...
      <section className="w-[100%] h-[44rem] xl:h-[50rem] flex justify-center items-center ">
        <div className="relative flex flex-col items-center justify-center w-full h-[44rem] xl:h-[50rem]">
          <div className="absolute top-0 left-0 w-full h-[15rem] overflow-hidden">
            ...
            />
            <motion.div
              className="absolute xs:top-[5rem] top-[8rem]   w-[100%] xs:ml-[40px] ml-[90px] sm:ml-[100px] md:ml-[150px] lg:ml-[250px]   py-5 h-[8rem]"
              initial={{ y: "-50%", opacity: 0 }}
              whileInView={{ y: 0, opacity: 1 }}
              transition={{ duration: 1.2, ease: [0.42, 0, 0.58, 1] }}
            >
              <h1 className="text-2xl font-bold text-black sm:text-3xl xl:text-4xl">
                {" "}
                Our <br></br>{" "}
                <span className="text-[#00CEB1] text-4xl sm:text-4xl md:text-5xl xl:text-6xl">
                  {" "}
                  Partners{" "}
                </span>{" "}
              </h1>
          ...
          <div className="absolute bottom-0 left-0 w-full h-[33rem] xl:h-[44rem]">
            ...
            />
            <img
              className="lg:hidden w-[100%] h-[33rem] xl:h-[44rem]"
          ...
          <motion.div
            className="hidden mt-[120px] xs:px-[10%] lg:grid lg:grid-cols-4 z-10 lg:mx-[5rem] xl:mx-[6rem] 2xl:mx-[8rem]"
            ...
            {partnersData.map((partner, index) => (
              <div
                ...
                className={`relative 
                                    ${
                                      index === 0
                                        ? "lg:mt-[9rem] xl:mt-[5rem]"
                                        : ""
                                    } 
                                    ${
                                      index === 1
                                        ? "lg:mt-[11rem] xl:mt-[7rem]"
                                        : ""
                                    } 
                                    ${
                                      index === 2
                                        ? "lg:mt-[9rem] xl:mt-[4rem] "
                                        : ""
                                    } 
                                    ${
                                      index === 3
                                        ? "lg:mt-[5rem] xl:mt-[-1rem] "
                                        : ""
                                    }`}
              >
                <PartnerCard
