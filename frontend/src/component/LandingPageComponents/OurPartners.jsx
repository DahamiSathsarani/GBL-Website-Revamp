...
const OurPartners = () => {
  return (
    <div>
        <section className='relative w-[100%] h-screen flex justify-center items-center overflow-x-hidden'>
            <div className='relative flex flex-col items-center justify-center w-full h-screen'>
                <div className="absolute top-0 left-0 w-full h-[30%] overflow-hidden">
                    <img className='w-[100%] h-[100%]'
                        ...
                        alt="Shape-Image"
                    />
                    <div className='absolute top-[50px] w-[100%] ml-[90px] sm:ml-[140px] lg:ml-[150px] lg:top-[80px] xl:top-[120px] py-5'>
                        <h1 className='text-2xl sm:text-3xl font-bold text-black'> Our <br></br> <span className='text-[#00CEB1] text-3xl sm:text-4xl'> Partners </span> </h1>
                    </div>
                </div>
                ...
                <div className="hidden mt-[120px] lg:grid lg:grid-cols-4 z-10">
                    {partnersData.map((partner, index) => (
                        <div 
                            key={index}
                            className={`relative ${index === 0 ? 'lg:mt-[6rem] xl:mt-[5rem]' : ''} 
                                    ${index === 1 ? 'lg:mt-[4rem] xl:mt-[4rem]' : ''} 
                                    ${index === 2 ? 'lg:mt-[2rem] xl:mt-[2rem]' : ''} 
                                    ${index === 3 ? 'lg:mt-[0rem] xl:mt-[-1rem]' : ''}`} >
                            <PartnerCard
                                logo={partner.logo}
