    ...
    return (
        <div className="h-screen flex flex-col">
            <div className="flex-1 h-[25%] text-white flex items-center justify-center relative">
                <svg
                    className="absolute w-screen transform rotate-180"
                ...
                <h2 className="text-center text-5xl font-semibold mb-6 relative z-10">Our Clients</h2>
            </div>
            ...
            <div className="flex-3 h-[45%] text-white flex items-center justify-center relative">
                ...
                >
                    ...
                    />
                    <defs>
                        <linearGradient id="gradients" x1="0" x2="1" y1="0" y2="1">
                            <stop offset="17%" stopColor="#1C3A7B" />
                            <stop offset="100%" stopColor="#85BFB7" />     
                        </linearGradient>
                    </defs>
                </svg>
