...
const PartnerCard = ({ logo, hoverLogo, content }) => {
  ...
  return (
    <div className="flex flex-col justify-center items-center w-full h-[400px]">
      ...
      <div
        className="w-[70%] h-[60%] sm:w-[70%] md:w-[50%] lg:w-[90%] lg:h-[50%] xl:w-[75%] xl:h-[55%] flex items-center text-black italic font-sans  bg-white rounded-xl text-center p-8 lg:p-3 xl:p-8 transition-all duration-700 "
        onMouseEnter={() => setIsHovered(true)}
        onMouseLeave={() => setIsHovered(false)}
        style={{
      ...
      >
        <p className="xs:text-[14px] text-[15px] sm:text-[17px] md:text-[20px] lg:text-[13px] 2xl:text-[15px]">
          {" "}
          {content}{" "}
        </p>
      </div>
