...
export default function SubHeroSection({
  ...
  return (
    <section className=" flex flex-col lg:flex-row w-full relative  top-[7rem] sm:top-[8rem] lg:top-[10rem]">
      <div className="w-full lg:w-[50%]">
        <h1 className="text-[40px] font-bold  sub-menu-gradient text-center">
          {topic}
        </h1>
        <img
          src={images.SubHeroSectionUpperWave}
          className="mt-[1rem] sm:mt-[2rem] mb-[2rem]"
        />
        <div>{description}</div>
      </div>
      <div className="xs:h-[35rem] h-[38rem] sm:h-[44rem] md:h-[50rem] lg:h-[45rem] xl:h-[50rem] 2xl:h-[60rem] relative flex flex-col w-full lg:w-[50%] mt-[2rem] lg:mt-0 ">
        <div className="xs:h-[20rem] h-[23rem] sm:h-[26rem] md:h-[30rem] lg:h-[26rem] xl:h-[30rem] 2xl:h-[35rem] w-full flex justify-center items-center  mt-5">
          <div className="">
            ...
            <div className="h-[3.5rem] w-[3.5rem] sm:h-[4.5rem] sm:w-[4.5rem] lg:h-[3.5rem] lg:w-[3.5rem] xl:h-[4.5rem] xl:w-[4.5rem]  rounded-[50%] border-[3px] border-[#7091E6] flex justify-center items-center relative left-[14rem] xs:left-[12.5rem] xs:top-[-4.5rem] top-[-4.5rem] sm:left-[21rem] sm:top-[-8rem] md:left-[24rem] lg:top-[-6rem] lg:left-[18rem] xl:top-[-7rem] xl:left-[23rem] 2xl:top-[-6.5rem] 2xl:left-[25.5rem] bg-white">
              <img
                src={lowerIcon}
                className="h-[2.5rem] w-[2.5rem] sm:h-[3.5rem] sm:w-[3.5rem]"
              />
        ...
        <img src={images.SubHeroSectionLowerWave} className="xs:mt-[1rem]   " />
      </div>
    </section>
  );
}
