...
const ProductCard = ({ title, icon: Icon, content }) => {
    return (
        <div className="xs:h-[540px] h-[550px] md:h-[500px] flex flex-col justify-center items-center text-white">
            <div className='relative xs:w-[80%] w-[60%] sm:w-[250px] md:w-[230px] lg:w-[250px] 2xl:w-[340px] h-[370px] 2xl:h-[420px] bg-gradient-to-t from-[#00CEB1] to-[#1C3A7B] rounded-t-full flex justify-center items-center'>
